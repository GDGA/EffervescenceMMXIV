...
public class Favourites {
	...
	public Favourites(Context c) {
		ourContext = c;
	}
	
	public Favourites openandwrite() throws SQLException{
	...
	public ArrayList<String> getData(int ch) {
		// TODO Auto-generated method stub
		...
		for(c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
			if(ch == 0)
			result.add("\n" + c.getString(iName)+"\n");
			else result.add(c.getString(iAddress));
